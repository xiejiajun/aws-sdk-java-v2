...
public class NettyMocks {
    ...
    public static void ignoreOptionSets(Channel mockChannel) {
        ChannelConfig config = mock(ChannelConfig.class);
        when(mockChannel.config()).thenReturn(config);
    }

    public static void ignorePipelineAdds(Channel mockChannel) {
