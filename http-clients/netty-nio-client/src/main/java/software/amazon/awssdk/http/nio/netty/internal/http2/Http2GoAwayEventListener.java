 ...
 */
@SdkInternalApi
public class Http2GoAwayEventListener extends Http2ConnectionAdapter {
    private static Logger log = Logger.loggerFor(Http2GoAwayEventListener.class);
    ...
    public void onGoAwayReceived(int lastStreamId, long errorCode, ByteBuf debugData) {
        log.info(() -> "Got GOAWAY on " + parentChannel.id());
