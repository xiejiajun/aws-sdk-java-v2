 ...
 *
 *     // Specify any headers that are needed by the service (not needed when isBrowserCompatible is true)
 ...
 *     });
 *
 *     // Send any request payload that is needed by the service (not needed when isBrowserCompatible is true)
 ...
 *
 *     // Specify any request payload that is needed by the service (not needed when isBrowserCompatible is true)
...
public interface S3Presigner extends SdkPresigner {
     ...
     *         presigner.presignGetObject(getObjectPresignRequest);
     *
     *     if (presignedGetObjectRequest.isBrowserCompatible())
